...
while True:
	...
	for rect in rects:
		...
		if ear < EYE_AR_THRESH:
			...
			if COUNTER >= EYE_AR_CONSEC_FRAMES:
				...
				cv2.putText(frame, "DROWSINESS ALERT!", (10, 50),
					cv2.FONT_HERSHEY_SIMPLEX, 0.7, (300, 20, 255), 2)

		# otherwise, the eye aspect ratio is not below the blink
		# threshold, so reset the counter and alarm
		else:
			COUNTER = 0
			cv2.putText(frame, "Eyes Open ", (10, 30),cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 0), 2)
		...
		cv2.putText(frame, "MAR: {:.2f}".format(mouEAR), (480, 60),
			cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
		cv2.putText(frame,"Srujankatukam",(465,475),cv2.FONT_HERSHEY_DUPLEX,0.7,(155,521,102),1)
	# show the frame
